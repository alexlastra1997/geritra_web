...
return [
    ...
    | convención "attribute.rule" para nombrar las líneas. Esto facilita la especificación de una línea de lenguaje personalizada específica para una regla de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para intercambiar marcadores de posición de atributos
    | con algo más amigable para el lector, como "Dirección de correo electrónico"
    | en lugar de "correo electrónico". Esto simplemente nos ayuda a hacer que los mensajes sean un poco más claros.
    |
    */
