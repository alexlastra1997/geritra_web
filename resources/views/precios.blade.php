  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
        <h2 class="m-7 text-4xl md:text-5xl tracking-tight font-extrabold text-blue-950 dark:text-white">PLANES EMPRESARIALES</h2>
          ...
          <a href="{{ route('contactos') }}" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-lime-500 hover:bg-lime-700 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
            Contáctanos
